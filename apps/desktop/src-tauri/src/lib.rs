...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::reconcile_gnucash_import,
            commands::read_qif_file,
            commands::qif_build_default_plan,
            commands::qif_apply_mapping_edit,
            commands::commit_qif_import,
            commands::rollback_qif_import,
            commands::reconcile_qif_import,
            commands::get_sensitivity,
